...
global button1
button1 = Button(window, text='LOGIN', font=('Comic Sans MS', 12), command=log_in, bg='blue',
                 fg='white', borderwidth=4, padx=3, pady=3).grid(row=5, column=2, columnspan=3, padx=2, pady=4)


label4 = Label(window, text="Don't have an account ?", font=('arial', 10))
label4.grid(row=6, column=1, pady=10)
button2 = Button(window, text="Click To Sign Up", font=('Comic Sans MS', 9), command=signup.sign_up,
                 bg='purple', fg='white', borderwidth=4, padx=3, pady=3).grid(row=6, column=2)
